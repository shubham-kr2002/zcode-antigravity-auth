...
interface CapabilityRule {
  /** Regex pattern to match against the model ID */
  pattern: RegExp;
  /** Higher priority rules win */
  priority: number;
  /** Capability generator for matched models */
  capabilities: (modelId: string, displayName?: string) => ModelCapabilities;
}
 ...
 */
export function supportsThinkingTiers(modelId: string): boolean {
 ...
 */
export function hasPreSuffixedTier(modelId: string): boolean {
 ...
 */
export function extractTierFromModel(modelId: string): string | undefined {
